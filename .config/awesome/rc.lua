...
awful.util.tagnames = { "School", "Programming", "Misc" }
...
globalkeys = mytable.join(
    ...
    awful.key({ altkey }, "XF86AutoLowerVolume",
        function ()
            os.execute(string.format("amixer -q set %s 1%%-", beautiful.volume.channel))
            beautiful.volume.update()
        end,
...
-- https://superuser.com/questions/1206957/cannot-get-firefox-to-tile-correctly-after-last-update-to-awesome-wm-in-arch
